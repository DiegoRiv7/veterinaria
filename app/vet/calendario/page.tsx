...
export default async function VetCalendarPage({
  ...
  // All appointments in this month for the dot indicators
  ...
  // Build cells: leading empty cells for first-day offset + day numbers
  ...
  return (
    <div className="grid gap-5 grid-cols-1 lg:grid-cols-[1.2fr_1fr]">
          ...
          {cells.map((d, i) => {
            ...
            return (
              <Link
                ...
                className="flex flex-col items-center justify-center py-1.5 px-1 rounded-[10px] gap-1 min-h-[44px] sm:min-h-[52px]"
                style={{
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-3.5 flex flex-col gap-2 max-h-[420px] lg:max-h-none">
          {dayAppts.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center gap-2 py-10" style={{ color: "var(--vet-text-3)" }}>
